...
//     const isApproved = (role === 'student' || !role); // Default to student if no role specified
//     console.log('Creating user with role:', role || 'student', 'and approval status:', isApproved);
...
//     // For students (auto-approved), generate and return a token
//     if (isApproved) {
...
//     // For teachers/admins (require approval)
//     res.status(201).json({ 
