      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-5xl font-extrabold text-gray-900 mb-6 leading-tight">
            {title === "Our Featured Courses" ||
            title === t("courseSection.header.title") ? (
              <>
        ...
        {showFilters && (
          <div className="flex flex-wrap justify-center gap-4 mb-16">
            {[
              {
                key: "all",
                label: t("courseSection.filters.all"),
                icon: "apps",
              },
              {
                key: "web development",
                label: t("courseSection.filters.webDevelopment"),
                icon: "code",
              },
              {
                key: "data science",
                label: t("courseSection.filters.dataScience"),
                icon: "analytics",
              },
              {
                key: "cybersecurity",
                label: t("courseSection.filters.cybersecurity"),
                icon: "security",
              },
              {
                key: "cloud computing",
                label: t("courseSection.filters.cloudComputing"),
                icon: "cloud",
              },
            ].map((filter) => (
              <button
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-12 sm:mb-16 auto-rows-fr">
          {displayedCourses.map((course, index) => (
            <div
              ...
              onClick={(e) =>
                onCourseCardClick && onCourseCardClick(course.id, e)
              }
            >
              ...
              <div className="relative overflow-hidden h-48 sm:h-56 lg:h-64">
                ...
                <div
                  className={`absolute top-2 sm:top-4 left-2 sm:left-4 px-2 sm:px-4 py-1 sm:py-2 rounded-full text-xs sm:text-sm font-bold shadow-xl backdrop-blur-sm ${getBadgeStyles(
                    course.badgeColor
                ...
                <div className="absolute top-2 sm:top-4 right-2 sm:right-4 bg-white/95 backdrop-blur-sm px-2 sm:px-4 py-1 sm:py-2 rounded-full flex items-center gap-1 sm:gap-2 shadow-xl transform group-hover:scale-110 transition-transform duration-300">
                  <span className="material-icons text-yellow-500 text-xs sm:text-sm">
                    star
                  </span>
                ...
                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300">
                  ...
                  >
                    ...
                    <span className="text-sm">
                      {t("courses.courseDetails.viewDetails")}
                    </span>
                  </button>
                </div>
              </div>
              ...
              <div className="p-4 sm:p-6 flex-1 flex flex-col">
                ...
                <div className="flex flex-wrap items-center justify-between mb-4 sm:mb-6 text-xs sm:text-sm gap-2">
                  <div className="flex items-center gap-1 sm:gap-2 bg-gray-100 px-2 sm:px-3 py-1 sm:py-2 rounded-full">
                    <span className="material-icons text-blue-600 text-xs sm:text-sm">
                      schedule
                    </span>
                  ...
                  <div className="flex items-center gap-1 sm:gap-2 bg-gray-100 px-2 sm:px-3 py-1 sm:py-2 rounded-full">
                    <span className="material-icons text-green-600 text-xs sm:text-sm">
                      people
                    </span>
                    <span className="font-semibold text-gray-700 text-xs sm:text-sm">
                  ...
                  <div className="flex items-center gap-1 sm:gap-2 bg-gray-100 px-2 sm:px-3 py-1 sm:py-2 rounded-full">
                    <span className="material-icons text-purple-600 text-xs sm:text-sm">
                      trending_up
                    </span>
                    <span className="font-semibold text-gray-700 text-xs sm:text-sm">
                      {course.level}
              ...
              <div className="px-3 sm:px-4 lg:px-6 pb-3 sm:pb-4 lg:pb-6">
                <div className="flex gap-1.5 sm:gap-2 lg:gap-3">
                  ...
                  >
                    <span className="material-icons text-xs sm:text-sm flex-shrink-0">
                      visibility
                    </span>
                  ...
                  >
                    ...
                    <span className="text-xs sm:text-sm truncate">
                      {t("courses.courseDetails.enroll")}
                    </span>
                  </button>
                </div>
              </div>
        ...
        {window.location.pathname !== "/courses" && (
          <div className="text-center bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-12 text-white">
            <h3 className="text-3xl font-bold mb-4">
              {t("courseSection.cta.title")}
            </h3>
            <p className="text-xl mb-8 opacity-90">
              {t("courseSection.cta.description")}
            </p>
            <Link
              to="/courses"
