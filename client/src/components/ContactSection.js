  ...
  const contactItems = [
    ...
    },
    {
      ...
      content: (
        <>
          <a
            href="tel:025-247-6300"
            className="hover:text-white transition-colors"
          >
            025-247-6300
          </a>{" "}
          ({t("contactSection.contact.phone.tel")})<br />
          <a
            href="tel:025-247-6305"
            className="hover:text-white transition-colors"
          >
            025-247-6305
          </a>{" "}
          ({t("contactSection.contact.phone.fax")})
        </>
      ),
  ...
  const socialLinks = [
    {
      ...
      url: "https://twitter.com/forumacademy",
      label: "Twitter",
      color: "from-blue-400 to-blue-600",
    },
    {
      icon: "facebook",
      url: "https://facebook.com/forumacademy",
      label: "Facebook",
      color: "from-blue-600 to-blue-800",
    },
    {
      icon: "photo_camera",
      url: "https://instagram.com/forumacademy",
      label: "Instagram",
      color: "from-pink-500 to-purple-600",
    },
    {
      icon: "work",
      url: "https://linkedin.com/company/forumacademy",
      label: "LinkedIn",
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Main Contact Card */}
        <div
          className={`relative bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden mb-16 border border-white/20 transition-all duration-1000 delay-300 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
          }`}
        >
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-6 pt-6 border-t border-gray-200/50">
                <div className="flex items-center gap-4">
                  <span className="text-gray-700 font-medium">
                    {t("contactSection.social.connect")}:
                  </span>
        ...
        <div
          className={`relative bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl p-8 lg:p-12 border border-white/20 transition-all duration-1000 delay-500 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
          }`}
        >
            ...
            {faqItems.map((faq, index) => (
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 mb-3 group-hover:text-gray-800 transition-colors">
                      {faq.question}
                    </h4>
