          ...
          <div className="bg-white border-b border-gray-200 px-4 sm:px-6 lg:px-8 py-4 sm:py-6 rounded-t-2xl">
            <div className="flex items-center justify-between">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-4">
                <div
                  className={`px-3 sm:px-4 py-1 sm:py-2 rounded-full text-xs sm:text-sm font-bold ${getBadgeStyles(
                    course.badgeColor
                  )}`}
                >
                  {course.category}
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <div className="relative overflow-hidden rounded-xl mb-4 sm:mb-6">
                    ...
                    <div className="absolute bottom-3 sm:bottom-4 left-3 sm:left-4 text-white">
                      ...
                      <div className="text-xs sm:text-sm line-through opacity-75">
              ...
              <div className="lg:col-span-2">
                ...
                <div className="mb-6 sm:mb-8">
                  <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-3 sm:mb-4 flex items-center gap-2">
                    <span className="material-icons text-blue-600 text-lg sm:text-xl">
                      lightbulb
                    </span>
                    What You'll Learn
                  </h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2 sm:gap-3">
                    {course.whatYouWillLearn.map((item, index) => (
                      <div
                        key={index}
                        className="flex items-start gap-2 sm:gap-3 p-2 sm:p-3 bg-green-50 rounded-lg"
                      >
                        <span className="material-icons text-green-500 text-sm mt-1">
                          check_circle
                        </span>
                ...
                <div className="mb-6 sm:mb-8">
                  <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-3 sm:mb-4 flex items-center gap-2">
                    <span className="material-icons text-purple-600 text-lg sm:text-xl">
                      menu_book
                    </span>
                    Curriculum
                  </h3>
                  <div className="space-y-2 sm:space-y-3">
                    {course.curriculum.map((item, index) => (
                      <div
                        key={index}
                        className="flex items-center gap-2 sm:gap-3 p-3 sm:p-4 bg-white border border-gray-200 rounded-lg hover:border-blue-300 hover:bg-blue-50 transition-all duration-200"
                      >
                ...
                <div className="mb-6 sm:mb-8">
                  <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-3 sm:mb-4 flex items-center gap-2">
                    <span className="material-icons text-orange-600 text-lg sm:text-xl">
                      assignment
                    </span>
                    Requirements
                  </h3>
                  <div className="space-y-2">
                    {course.requirements.map((item, index) => (
                      <div
                        key={index}
                        className="flex items-start gap-2 sm:gap-3 p-2 sm:p-3 bg-orange-50 rounded-lg"
                      >
                ...
                <div className="mb-6 sm:mb-8">
                  <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-3 sm:mb-4 flex items-center gap-2">
                    <span className="material-icons text-green-600 text-lg sm:text-xl">
                      work
                    </span>
                    Career Outcomes
                  </h3>
                ...
                <div className="mb-6 sm:mb-8">
                  ...
                  <div className="flex flex-wrap gap-2 sm:gap-3">
                    {course.companies.map((company, index) => (
                      <div
                        key={index}
                        className="px-3 sm:px-4 py-1 sm:py-2 bg-orange-100 text-orange-700 rounded-full font-medium text-xs sm:text-sm"
                      >
                        {company}
                      </div>
                    ))}
