          ...
          <div className="flex items-center justify-between h-16 lg:h-18 min-w-0">
            ...
            >
              ...
              <div className="hidden md:block flex-shrink-0 min-w-0">
                <h1
                  className={`font-bold text-sm md:text-base leading-tight transition-colors duration-300 whitespace-nowrap ${
              ...
              {i18n.language === "ja" ? (
                <>
                          ...
                          <div className="space-y-2">
                            {coursesData.map((course, index) => {
                              ...
                              return (
                                ...
                                >
                                  <div
                                    className={`w-10 h-10 rounded-lg bg-gradient-to-r ${course.gradient} flex items-center justify-center group-hover:scale-105 transition-transform duration-200`}
                                  >
                  ...
                  >
                    ...
                    {/* Japanese About Dropdown */}
                    <div
                      className={`absolute top-full left-0 w-80 max-w-[85vw] transition-all duration-300 z-50 ${
                        dropdownOpen === "about"
                          ? "opacity-100 translate-y-0 pointer-events-auto"
                          : "opacity-0 -translate-y-2 pointer-events-none"
                      }`}
                ...
                >
                  <div className="mt-2 pl-4 space-y-2">
                    {coursesData.map((course, index) => (
                      ...
                      >
                        <div
                          className={`w-6 h-6 rounded-lg bg-gradient-to-r ${course.gradient} flex items-center justify-center`}
                        >
